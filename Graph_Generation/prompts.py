...
Return the entity types as shown in the example
Do not return any other information, not even the reasoning, just the output
=====================================================================
...
Text: Example_Org_A is a company in Sweden founded in 1998. Example_Org_A's director is Example_Individual_B.
RESPONSE:

{{"entity_type": ["organization", "person", "time"]}}
...
{{"entity_type":["concept", "person", "school of thought"]}}
...
4. Do not return any other information, not even the reasoning, just the output
5. Return the output as shown in the example
######################
-Examples-
######################
Example 1:

Entity_types: [person, technology, mission, organization, location,time]
Text:
while Alex clenched his jaw at noon, the buzz of frustration dull against the backdrop of Taylor's authoritarian certainty. It was this competitive undercurrent that kept him alert, the sense that his and Jordan's shared commitment to discovery was an unspoken rebellion against Cruz's narrowing vision of control and order.
...
{{
  "entity_name": ["Alex", "Taylor", "Jordan", "Cruz","Noon","Device"],
  "entity_type": ["person", "person", "person", "person","time","technology"],
  "entity_description": [
    ...
    "Noon is the time of day when Alex's jaw clenched.",
    "Device is a piece of technology that Taylor showed reverence for."
  ]
}}
...
5. Do not return any other information, not even the reasoning, just the output
6. Return the output as shown in the example.
 ######################
-Examples-
######################
Example 1:

Entities: Alex,Taylor,Jordan,Cruz,Noon,The Device
Text:
while Alex clenched his jaw at noon, the buzz of frustration dull against the backdrop of Taylor's authoritarian certainty. It was this competitive undercurrent that kept him alert, the sense that his and Jordan's shared commitment to discovery was an unspoken rebellion against Cruz's narrowing vision of control and order.
